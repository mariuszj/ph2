...
pow_1=pd.read_csv('dane_mocy_miesieczne_2/052021_moc_1.csv')
...
write_api.write(bucket=bucket, org=org, record=pow_1, data_frame_measurement_name='moce', data_frame_tag_columns=['id_farmy','zrodlo'])
